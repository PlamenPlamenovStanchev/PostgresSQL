...
CREATE TABLE bookings_calculations AS
SELECT
	booked_for
FROM
	bookings
...
SELECT	* FROM bookings_calculations;

ALTER TABLE bookings_calculations
ADD COLUMN multiplication NUMERIC,
ADD COLUMN modulo NUMERIC;

UPDATE bookings_calculations
SET
